...
func InsertKeuanganFacopi(KeuanganFakopi *KeuanganFacopiModels.KeuanganFakopi) Models.BaseResponseModels {
	...
	query = "INSERT INTO DataFacopi (Kode, Sub_Day, Sub_Week, Sub_Month, Sub_Year, Penjualan_Masuk, Penjualan_Keluar, Penjualan_Bersih, Total_Penjualan, Jumlah_Cup_Terjual, Pemasukan_Week, Pemasukan_Month, Pengeluaran_Week, Pengeluaran_Month, Total_Week, Total_Month, Keterangan) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
...
func UpdateKeuanganFacopi(KeuanganFakopi *KeuanganFacopiModels.KeuanganFakopi) Models.BaseResponseModels {
	...
	query = "UPDATE DataFacopi SET Sub_Day = ?, Sub_week = ?, Sub_Month = ?, Sub_Year = ?, Penjualan_Masuk = ?, Penjualan_Keluar = ?, Penjualan_Bersih = ?, Total_Penjualan = ?, Jumlah_Cup_Terjual = ?, Pemasukan_Week = ?, Pemasukan_Month = ?, Pengeluaran_Week = ?, Pengeluaran_Month = ?, Total_Week = ?, Total_Month = ?, Keterangan = ? WHERE Kode = ?"
...
func GetKeuanganFacopiByID(request *KeuanganFacopiModels.KeuanganFakopi) Models.BaseResponseModels {
	...
	tempResult := db.Raw(query, request.Kode).Find(&KeuanganFacopi)
